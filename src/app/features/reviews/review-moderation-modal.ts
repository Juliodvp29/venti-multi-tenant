          ...
          <div class="grid grid-cols-2 gap-8 mb-8">
            ...
            <div class="space-y-3">
              ...
              <div class="flex items-center gap-4">
                <div
                  class="w-12 h-12 rounded-2xl bg-indigo-50 flex items-center justify-center text-indigo-600 font-black text-lg"
                >
            ...
            <div class="space-y-3">
              ...
              <div class="flex items-center gap-4">
                <div
                  class="w-12 h-12 rounded-2xl bg-slate-50 border border-slate-100 overflow-hidden"
                >
