...
export class SettingsStorefront {
  ...
  readonly savedLayout = signal<StorefrontLayout>(
    structuredClone(this.tenantService.storefrontLayout()),
  );
  ...
  readonly pageHeaderStyleOptions: {
    label: string;
  ...
  }[] = [
    {
      label: 'Estándar',
      value: 'default',
      description: 'Barra de navegación completa de la tienda',
    },
    {
      label: 'Transparente',
      value: 'transparent',
      description: 'Fondo transparente flotante sobre el banner',
    },
  ...
  readonly pageFooterStyleOptions: {
    label: string;
    value: PageFooterStyle;
    description: string;
  }[] = [
    {
      label: 'Estándar',
      value: 'default',
      description: 'Pie de página completo con redes y datos',
    },
    {
      label: 'Compacto',
      value: 'compact',
      description: 'Pie de página simplificado con copyright',
    },
  ...
  readonly sectionCatalog: SectionMeta[] = [
    // Hero & Cabecera
    {
      ...
      name: 'Hero Principal',
      description:
        'Banner principal de gran impacto visual con botones de acción e imagen o video de fondo.',
    ...
    },
    {
      ...
      description:
        'Temporizador de cuenta regresiva para generar urgencia en lanzamientos o ventas especiales.',
    ...
    },
    {
      ...
      name: 'Ofertas Flash',
      description:
        'Bloque dinámico de promociones con badge de descuento y botón de compra rápida.',
  ...
  private updateActivePageSections(
    updater: (sections: StorefrontSection[]) => StorefrontSection[],
  ) {
    const pageId = this.activePageId();
  ...
  addSection(type: SectionType) {
    ...
    this.toast.success(
      `Sección "${this.getSectionName(type)}" agregada a ${this.activePageMeta().label}.`,
    );
  }
  ...
  duplicateSection(id: string) {
    ...
    const cloned: StorefrontSection = {
      ...
      id: crypto.randomUUID(),
      titleCustom: source.titleCustom
        ? `${source.titleCustom} (Copia)`
        : `${this.getSectionName(source.type)} (Copia)`,
    };
  ...
  async saveLayout(silent = false): Promise<boolean> {
    ...
    try {
      ...
      if (result.success) {
        ...
        if (!silent) this.toast.success('Diseño de la tienda actualizado exitosamente');
        this.dirtyChange.emit(false);
        return true;
      } else {
        if (!silent) this.toast.error(result.error || 'Error al actualizar el diseño');
        return false;
      }
    } catch (error) {
      console.error('Error saving layout:', error);
      if (!silent) this.toast.error('Ocurrió un error inesperado al guardar el diseño');
      return false;
    } finally {
    ...
    switch (type) {
      case 'hero':
        return {
          ...
          subtitle:
            'Descubre piezas exclusivas diseñadas con la máxima atención al detalle y acabados premium.',
      ...
      case 'offers':
        return {
          ...
          description:
            'Descuentos increíbles en artículos seleccionados. ¡No te quedes sin el tuyo!',
          ...
          items: [
            {
              ...
              content:
                'La calidad de los productos superó todas mis expectativas. El envío fue súper rápido y el empaque impecable.',
              rating: 5,
              avatarUrl:
            ...
            },
            {
              ...
              content:
                'Excelente atención al cliente y productos auténticos. Sin duda volveré a comprar aquí.',
              rating: 5,
              avatarUrl:
            ...
            },
            {
              ...
              content:
                'El diseño y los materiales son de primer nivel. Es mi tienda favorita para encontrar piezas únicas.',
              rating: 5,
              avatarUrl:
                'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&q=80&w=150',
            },
          ...
          items: [
            {
              ...
              comment:
                'Llegó en perfecto estado, tal como se mostraba en las fotos. El soporte respondió todas mis dudas al instante.',
              verified: true,
            },
            {
              id: '2',
              ...
              comment:
                'Compré para un regalo y fue un éxito total. Muy buena relación calidad-precio.',
              verified: true,
            },
            {
              id: '3',
              ...
              comment:
                'El producto es hermoso, solo tardó un día más de lo estimado pero valió la pena.',
              verified: true,
            },
          ],
        };
      ...
      case 'about_us':
        return {
          ...
          content:
            'Nacimos con el propósito de ofrecer productos de la más alta calidad, uniendo diseño contemporáneo con procesos sostenibles y un servicio al cliente inigualable.',
          imagePosition: 'right',
          imageUrl:
      ...
      case 'newsletter':
        return {
          ...
          description:
            'Sé el primero en enterarte de nuevos lanzamientos, eventos especiales y descuentos para miembros.',
          ...
          items: [
            {
              ...
              answer:
                'Los envíos estándar toman entre 2 y 4 días hábiles. También contamos con envíos exprés con entrega en 24-48 horas.',
            },
            {
              id: '2',
              question: '¿Cuáles son los métodos de pago aceptados?',
              answer:
                'Aceptamos tarjetas de crédito y débito (Visa, Mastercard, AMEX), transferencias bancarias y pagos en efectivo contra entrega.',
            },
            {
              id: '3',
              question: '¿Puedo solicitar cambios o devoluciones?',
              answer:
                'Sí, tienes hasta 30 días posteriores a tu compra para solicitar un cambio o reembolso total si no quedas satisfecho.',
            },
            {
              id: '4',
              question: '¿Los productos cuentan con garantía?',
              answer:
                'Todos nuestros productos incluyen una garantía oficial de 1 año contra defectos de fabricación.',
            },
          ],
        };
          ...
          items: [
            {
              ...
              icon: '🚀',
              title: 'Envío Rápido',
              description: 'Entrega garantizada y seguimiento en tiempo real.',
            },
            {
              id: '2',
              icon: '🔒',
              title: 'Pago 100% Seguro',
              description: 'Tus transacciones están protegidas con cifrado SSL.',
            },
            {
              id: '3',
              icon: '✨',
            ...
            },
            {
              ...
              icon: '💬',
              title: 'Atención 24/7',
              description: 'Soporte personalizado listo para ayudarte siempre.',
            },
          ],
        };
      ...
      case 'countdown':
        return {
          ...
          description:
            'Prepárate para las mayores promociones del año. El contador está en marcha.',
