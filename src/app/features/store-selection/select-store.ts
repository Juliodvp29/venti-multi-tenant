            ...
            <div class="space-y-4">
              @for (store of stores(); track store.id) {
                <button
                  ...
                  class="w-full text-left p-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-750 hover:bg-indigo-50 dark:hover:bg-gray-700 hover:border-indigo-200 dark:hover:border-indigo-500 transition-all flex items-center justify-between group"
                >
