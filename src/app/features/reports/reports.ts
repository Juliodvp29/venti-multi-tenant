...
export class Reports {
    ...
    readonly customerColumns: ColumnDef<any>[] = [
        ...
        { key: 'total_orders', label: 'Pedidos', sortable: true },
    ...
    readonly summaryColumns: ColumnDef<any>[] = [
        ...
        { key: 'average_order_value', label: 'Valor Promedio Pedido', type: 'currency', sortable: true }
    ];
    ...
    async loadReports() {
        ...
        try {
            ...
            console.error('Error al cargar informes BI:', error);
            this.toast.error('Error al cargar informes BI');
        } finally {
